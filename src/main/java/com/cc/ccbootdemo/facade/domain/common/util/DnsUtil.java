...
public class DnsUtil {
    ...
    public static void main(String[] args) {
        System.out.println(valid("13758080693@163.com",""));
    }
    ...
    public static boolean valid(String toMail, String domain) {
        ...
        try {
            ...
            // 开始 smtp 注意大部分服务器厂商对25端口进行了屏蔽 最好使用smtp服务器的其他端口  465 SSL加密 587 TLS加密
            socket.connect(new InetSocketAddress(mxHost, 465));
