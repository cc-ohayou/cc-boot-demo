...
public class DateUtil {
    ...
    public static final ThreadLocal<DateFormat> HM_FORMAT = new ThreadLocal<DateFormat>() {
        @Override
        protected DateFormat initialValue() {
...
//        System.out.println(isLastDayOfMonth());
        ...
        System.out.println(DateUtil.getAfterMinutes(new Date(),15));
    ...
    public static int getMinuteIntervalToNow(Date createTime) {

        long between = (System.currentTimeMillis() - createTime .getTime())/1000;
        int min = Math.toIntExact(between / 60);
        return min;
    }
}
