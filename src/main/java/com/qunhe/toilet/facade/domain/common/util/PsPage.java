...
/**
 * @AUTHOR FangChunjie
 * @DATE Created on 2017/12/15 13:31.
 */
public class PsPage<T> {
    ...
    public static void main(String[] args) {
        PsPage<Integer> p = new PsPage<Integer>(null, 9, 20, 11);

    }

    public PsPage(List<T> items, int totalCount, int pageSize, int currentPage) {
        if(items==null){
